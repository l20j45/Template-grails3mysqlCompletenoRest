...
class SciformaProjectNewControllerSpec extends Specification implements ControllerUnitTest<SciformaProjectNewController>, DomainUnitTest<SciformaProjectNew> {
    ...
    void "Test the index action returns the correct model"() {
        ...
        !model.sciformaProjectNewList
        model.sciformaProjectNewCount == 0
    }
    ...
    void "Test the save action with a null instance"() {
        ...
        response.redirectedUrl == '/sciformaProjectNew/index'
        flash.message != null
    }
    ...
    void "Test the save action correctly persists"() {
        ...
        response.redirectedUrl == '/sciformaProjectNew/show/1'
    ...
    void "Test the show action with a valid id"() {
        ...
        model.sciformaProjectNew instanceof SciformaProjectNew
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new SciformaProjectNew())
